...
| `scripts/additions_v22.json` | 173 صنفًا إضافيًا مع نطاق السعر |
...
- أُضيف قسم "Additional Varieties - Price List v22" في نهاية الكاتالوج: 173 صنفًا من قائمة 22 غير موجودة في الكاتالوج المصوّر، والسعر يظهر كنطاق عند تعدد المقاسات.
